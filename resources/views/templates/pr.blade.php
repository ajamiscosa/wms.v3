    ...
    <div class="card flat collapsed-card">
        <div class="card-header">
            <div class="col-lg-12">
                <div class="row">
                    <div class="col-lg-2">
                        <a class="btn btn-flat btn-danger btn-sm shadow title-button" href="/purchase-request/view/{{ $issuance->OrderNumber }}"><i class="fa fa-copy"></i>&nbsp;<strong>{{ $issuance->OrderNumber }}</strong></a><br/>
