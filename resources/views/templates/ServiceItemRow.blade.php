<tr class="line-item">
    ...
    <td class='text-center align-middle'>
        <div class='col-md-12'>
            <div class='row'>
                <div class='col-md-12 input-group text-center' style='padding-left: 0; display: inline-flex;' align="center">
                    <input type="hidden" name="Quantity[]" value="1"/>
                    <span style="display:table; margin:0 auto;">1&nbsp;{{ $data->UOM()->Abbreviation }}</span>
                </div>
            </div>
        </div>
    </td>
