@extends('templates.content',[
    ...
    'breadcrumbs' => [
        ...
        \App\Classes\Breadcrumb::create('Stock Adjustment')
    ]
])
        ...
        <div class="col-md-12">
            <div class="card card-danger card-outline flat"> <!--  collapsed-card-->
                <div class="card-header">
                    <h4 class="card-title" style="display: inline-block">Stock Adjustments</h4>
                </div>
                @if(auth()->user()->isAuthorized('StockAdjustments','M'))
                <div class="card-body">
                    <h3 class="card-title">
                        <a href="/stock-adjustment/new" id="add-warehouse" class="btn btn-flat pull-right btn-fill btn-danger btn-md" style="margin-left: 8px;">New Adjustment</a>
                    </h3>
                </div>
                @endif
                <div class="card-body">
