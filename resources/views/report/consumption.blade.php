@extends('templates.content',[
    ...
    'description'=>'Shows an realtime consumption report for all items.',
    'breadcrumbs' => [
        \App\Classes\Breadcrumb::create('Home','/'),
        \App\Classes\Breadcrumb::create('Reports','/reports'),
        \App\Classes\Breadcrumb::create('Consumption Report')
    ]
])
                                ...
                                @if($products->count()>0)
                                    @foreach($products as $product)
                                        <tr role="row" class="{{ $loop->index % 2 ? "odd":"even" }}">
                                            ...
                                            <td class="text-right">
                                                {{--<a href="/reports/consumption/{{ $product->UniqueID }}/view" class="btn btn-sm btn-default"><i class="fa fa-search"></i>&nbsp;View</a>&nbsp;--}}
                                                <a href="/reports/consumption/{{ $product->UniqueID }}/export" class="btn btn-sm btn-default"><i class="fa fa-download"></i>&nbsp;Download</a>&nbsp;
                                            </td>
                                        </tr>
                                    @endforeach
                                @else
