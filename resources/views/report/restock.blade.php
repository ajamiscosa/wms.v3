@extends('templates.content',[
    'title'=>'Items For Restocking Report',
    'description'=>'Shows list of all inventory items that needs to be restocked.',
    'breadcrumbs' => [
        \App\Classes\Breadcrumb::create('Home','/'),
        \App\Classes\Breadcrumb::create('Reports','/reports'),
        \App\Classes\Breadcrumb::create('Items For Restocking Report')
    ]
])
...
@section('content')
    <div class="card card-danger card-outline flat">
        <div class="card-header card-header-text xwrapper">
            <h3 class="card-title">
                <strong>Items For Restocking Report</strong>
            </h3>
        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-12">
                                <div class="input-group float-right">
                                    <a href="/reports/item-restock/export" target="_blank" role="button" class="btn btn-danger btn-flat">
                                        Export
                                    </a>
                                    &nbsp;
                                    &nbsp;
