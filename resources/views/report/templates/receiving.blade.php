        ...
        @foreach($data->OrderItems as $item)
            ...
            @if($counter<19)
                ...
                @if($currency=="USD")
                    ...
                    @php($totalCUR += $quote->Amount * $item->Quantity * $usd)
                    ...
                    <div title="" class="textBox103 s10-" style="position:absolute;overflow:hidden;left:504px;top:{{$y}}px;width:95px;height:19px;">{{ number_format($totalUSD, 2, '.', ',') }}</div>
                    <div title="" class="textBox104 s11-" style="position:absolute;overflow:hidden;left:604px;top:{{$y}}px;width:80px;height:19px;">{{ $quote->Amount * $usd }}</div>
                    <div title="" class="textBox105 s9-" style="position:absolute;overflow:hidden;left:688px;top:{{$y}}px;width:84px;height:19px;">{{ number_format($totalCUR,2,'.',',') }}</div>
                @else
