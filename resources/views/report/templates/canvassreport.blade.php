...
<body class="cprint-page">
<div class="crsheet {{$data->Page??'page1'}}" style="padding-left:38px;padding-right:38px;padding-top:38px;padding-bottom:38px;width:979px;height:739px;">
    <div class="crlayer">
