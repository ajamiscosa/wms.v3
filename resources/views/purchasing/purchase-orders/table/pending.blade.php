<div id="datatables_wrapper" class="dataTables_wrapper dt-bootstrap">
    <table id="pendingTable" class="table table-responsive-lg dataTable dtr-inline" cellspacing="0" width="100%" style="width: 100%;" role="grid" aria-describedby="datatables_info">
        <thead>
        <tr role="row">
