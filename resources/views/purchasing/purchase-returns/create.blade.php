                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <h3 class="card-title" style="padding-top: 0; margin-top: 0;">
                                <strong>New Purchase Return</strong>
                            </h3>
                        </div>
                    </div>
                </div>
                <form action="/purchase-return/store" method="post">
                    {{csrf_field()}}
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control datepicker" id="ReturnDate" name="ReturnDate" value="{{ \Carbon\Carbon::today()->format('M d, Y') }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row" id="mydiv">
                            <div class="col-lg-12">
                                <table id="roTable" class="table table-striped table-no-bordered table-hover dataTable dtr-inline" cellspacing="0" width="100%" style="width: 100%;" role="grid" aria-describedby="datatables_info">
                                    ...
                                    @endphp
                                    @php
                                        foreach($data->ReceiveOrders() as $order){
