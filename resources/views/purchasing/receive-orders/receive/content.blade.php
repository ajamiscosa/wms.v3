                                    ...
                                    <td>
                                        <div class="input-group my-colorpicker2 colorpicker-element float-right">
                                            @if($lineItem->getRemainingDeliverableQuantity()>0)
                                                <input class="form-control text-right middle-dis" type="number" step="{{ $product->UOM()->Type==1?"0.001":"1" }}" name="Quantity[]" max="{{$lineItem->getRemainingDeliverableQuantity()}}" style="max-width: 100px;" required/>
