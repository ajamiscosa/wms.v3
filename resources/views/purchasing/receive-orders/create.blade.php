@extends('templates.content',[
    'title'=>"Receiving of $data->OrderNumber",
    ...
    'breadcrumbs' => [
        ...
        \App\Classes\Breadcrumb::create("$data->OrderNumber",'/purchase-order/view/'.$data->OrderNumber),
            ...
            <div class="card card-danger card-outline flat"> <!--  collapsed-card-->
                ...
                <div class="card-body">
                    <div class="tab-content">
                        @include('purchasing.receive-orders.receive.details')

                        @include('purchasing.receive-orders.receive.transactions')
                    </div>
                </div>
            </div>
        </div>
