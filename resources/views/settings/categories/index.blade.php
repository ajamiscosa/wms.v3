@extends('templates.content',[
    ...
    'breadcrumbs' => [
        ...
        \App\Classes\Breadcrumb::create('Category')
    ]
])
@section('styles')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-danger card-outline flat"> <!--  collapsed-card-->
                ...
                <div class="card-body">
                    <h3 class="card-title">
                        <a href="/category/new" id="add-warehouse" class="btn btn-flat pull-right btn-fill btn-danger btn-md" style="margin-left: 8px;">Add New Category</a>
                    </h3>
                </div>
                <div class="card-body">
            ...
            columnDefs: [
                {
                    render: function ( data, type, row ) {
                        return '<a class="alert-link" href="/category/view/'+data+'">'+data+'</a>';
                    },
                    targets: 0
