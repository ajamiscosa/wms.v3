        ...
        <div class="col-md-12">
            <div class="card card-danger card-outline flat"> <!--  collapsed-card-->
                <div class="card-header card-header-icon">
                    <h4 class="card-title" style="display: inline-block">Warehouse Locations</h4>
                </div>
                <div class="card-body">
                    <h3 class="card-title">
                        <a href="/location/new" id="add-warehouse" class="btn btn-flat pull-right btn-fill btn-danger btn-md" style="margin-left: 8px;">Add New Warehouse Location</a>
                    </h3>
                </div>
                <div class="card-body">
            ...
            columnDefs: [
                {
                    render: function ( data, type, row ) {
                        var ID = row['ID'];
                        return '<a class="alert-link" href="/location/view/'+ID+'-'+data+'">'+data+'</a>';
                    },
                    targets: 0
