@extends('templates.content',[
    ...
    'description'=>'View details of General Ledger Codes',
    'breadcrumbs' => [
...
@section('title',"Viewing $data->Code")
@section('styles')
@endsection
@php
        ...
        <div class="col-lg-4 col-md-12">
            <div class="card card-danger card-outline flat"> <!--  collapsed-card-->
                <div class="card-header card-header-text">
                    <h3 class="card-title" style="padding-top: 0; margin-top: 0;"><strong>General Ledger Code: </strong>{{ $data->Code }}
                        @if(!$data->Status)
                ...
                <div class="card-body" style="padding-bottom: 0px;">
                    <div class="row">
                        <div class="col-md-12">
                            <form action="/gl/toggle/{{ $data->Code }}" method="post">
                                {{ csrf_field() }}
                            @if($data->Status)
